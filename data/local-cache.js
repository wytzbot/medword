...
const DEFAULT={profile:{level:1,xp:0,streak:0,totalLevels:0,category:'Anatomy',lastCompletedDate:null},progress:{},terms:{}};
let state;
function load(){
 try{
  ...
  state=raw&&typeof raw==='object'?{...DEFAULT,...raw,profile:{...DEFAULT.profile,...raw.profile},progress:raw.progress||{},terms:raw.terms||{}}:structuredClone(DEFAULT);
...
export const store={
 ...
 setTerms(cat,terms){state.terms[cat]=Array.isArray(terms)?terms.slice(0,200):[];save()}
};
